...
<h4>Video 1:</h4>
	 ...
	 <div class="adminEditArticle" style="margin-left: 6rem;"> 
	    <div class="form-group">	      
         ...
         <input type="text" name="Uploader1"  class="form-control">
      </div>
	  ...
	  <div class="adminEditArticle" style="margin-left: 6rem;">
	  	    <div class="form-group">
         <h4>Video Link 2:</h4>
         <input type="text" name="VideoLink2"  class="form-control">
      </div>
	  	 <div class="form-group">
         <h4>Video Title 2:</h4>
         ...
         <input type="text" name="Uploader2" class="form-control">
      </div>
	  </div>
	  ...
	  <div class="adminEditArticle" style="margin-left: 6rem;">
	  	    <div class="form-group">
         <h4>Video Link 3:</h4>
         <input type="text" name="VideoLink3"  class="form-control">
      </div>
	  	 <div class="form-group">
         <h4>Video Title 3:</h4>
         ...
         <input type="text" name="Uploader3"  class="form-control">
      </div>
	  </div>
