...
<div class="container">
   <h1>Edit</h1>
   <a href="approved-index.php" class="btn btn-primary">Back</a>
   <form method="POST">
...
<div class="form-group">
	 ...
	 <div class="adminEditArticle" style="margin-left: 6rem;"> 
	    <div class="form-group">	      
         ...
         <h4>Video Link:</h4>
         <input type="text" name="VideoLink" value="<?php echo $entry->VideoLink1; ?>" class="form-control">
      </div>
	  
	  	  	 <div class="form-group">
         <h4>Video Title:</h4>
         <input type="text" name="VideoTitle" value="<?php echo $entry->Title1; ?>" class="form-control">
      </div>
	  	  	    <div class="form-group">
         <h4>Video Uploader:</h4>
         <input type="text" name="VideoUploader" value="<?php echo $entry->Uploader1; ?>" class="form-control">
      </div>
	  ...
	  <div class="adminEditArticle" style="margin-left: 6rem;">
         ...
         <input type="text" name="VideoLink2" value="<?php echo $entry->VideoLink2; ?>" class="form-control">
	  	 ...
	  	 <div class="form-group">
         <h4>Video Title 2:</h4>
         <input type="text" name="VideoTitle2" value="<?php echo $entry->Title2; ?>" class="form-control">
      </div>
	  	  	    <div class="form-group">
         <h4>Video Uploader 2:</h4>
         <input type="text" name="VideoUploader2" value="<?php echo $entry->Uploader2; ?>" class="form-control">
      </div>
	  </div>
	  ...
	  <div class="adminEditArticle" style="margin-left: 6rem;">
         ...
         <input type="text" name="VideoLink3" value="<?php echo $entry->VideoLink3; ?>" class="form-control">
	  	 ...
	  	 <div class="form-group">
         <h4>Video Title 3:</h4>
         <input type="text" name="VideoTitle3" value="<?php echo $entry->Title3; ?>" class="form-control">
      </div>
	  	  	    <div class="form-group">
         <h4>Video Uploader 3:</h4>
         <input type="text" name="VideoUploader3" value="<?php echo $entry->Uploader3; ?>" class="form-control">
      </div>
	  </div>
      ...
      <div class="form-group">
            ...
            <div class="form-group">
               <h4>Year:</h4>
               <input type="text" name="Date" value="<?php echo $entry->Date; ?>" class="form-control" placeholder="Year">
            </div>
      ...
      <div class="adminEditArticle" style="margin-left: 6rem;">
            ...
            <div class="form-group">
               <h5>Article Name <h5>
               <input type="text" name="ArticleName2" value="<?php echo $entry->ArticleName2; ?>" class="form-control" placeholder="ArticleName">
            </div>
    ...
    <div class="form-group">
            <h5>Tags</h5>
            <input type="text" name="Tag" value="<?php echo $entry->Tag; ?>"class="form-control" placeholder="ArticleName">
         </div>
      <div class="form-group">
